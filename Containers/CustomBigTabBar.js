...
exports.CustomBigTabBar = undefined;
...
var _Styles = require('./BigMenuStyles.native');
...
var CustomBigTabBar = exports.CustomBigTabBar = function (_React$PureComponent) {
    (0, _inherits3['default'])(CustomBigTabBar, _React$PureComponent);

    function CustomBigTabBar(props) {
        (0, _classCallCheck3['default'])(this, CustomBigTabBar);

        var _this = (0, _possibleConstructorReturn3['default'])(this, (CustomBigTabBar.__proto__ || Object.getPrototypeOf(CustomBigTabBar)).call(this, props));
    ...
    (0, _createClass3['default'])(CustomBigTabBar, [{
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    ...
                    renderTab ? renderTab(tab) : _react2['default'].createElement(
                        _reactNative.View,
                        { style:{width : 450 , paddingLeft : 14, backgroundColor: '#eaeaea'}},
                        tab.title
                    )
                )
            );
        ...
        value: function render() {
            ...
            //  styles = this.props.bigMenu ? BigMenu['default'] : _Styles2['default'];
    ...
    return CustomBigTabBar;
}(_react2['default'].PureComponent);

CustomBigTabBar.defaultProps = {
    animated: true,
    tabs: [],
